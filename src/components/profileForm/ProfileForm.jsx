        ...
        <div id="UpdateProfile">
          <form id="UserProfile" ref={form} onSubmit={onSubmit}>
            <section className={styles.PersonalInfo}>
              ...
              />
              <InputSection
                field={{ type: "url", name: "githubUrl", label: "GitHub" }}
                value={initialFormData?.otherInfo?.githubUrl}
              />
              <InputSection
                field={{ type: "url", name: "linkedinUrl", label: "LinkedIn" }}
                value={initialFormData?.otherInfo?.linkedinUrl}
              />
              <InputSection
                field={{
                  type: "select",
                ...
                value={initialFormData?.qualification}
              />
              <InputSection
                field={{
                  type: "select",
                  name: "availability",
                  label: "Availability *",
                  options: ["Full Time", "Part Time", "Unavailable"],
                  required: true,
                }}
                value={initialFormData?.availability}
              />
              ...
              <InputSection
                field={{ type: "textArea", name: "summary", label: "About" }}
            ...
            <section className={styles.Projects}>
              ...
              >
                {projects.map((project, index) => (
                  <div
                    className="Cell"
                    key={project.title ? project.title : index}
                  >
                    <InputSection
                      value={project.title}
                      field={{
            ...
            <section>
              ...
              {skills.map((skill, index) => (
                <Badge key={skill.skill} onClose={() => deleteSkill(index)}>
                  {skill.skill}
                </Badge>
              ))}
            </section>
